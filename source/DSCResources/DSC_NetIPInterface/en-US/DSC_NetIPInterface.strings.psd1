...
ConvertFrom-StringData @'
    ...
    NetIPInterfaceDoesNotExistMessage = Net IP interface for alias '{0}' and address family '{1}' does not exist.
    NetIPInterfaceParameterValueMessage = Net IP interface for alias '{0}' and address family '{1}' parameter '{2}' is '{3}'.
    ...
    PropertyNoMatchMessage = The property '{0}' value '{1}' does not match the desired value '{2}'.
'@
