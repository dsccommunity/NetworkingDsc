ConvertFrom-StringData @'
    ...
    InvalidNetAdapterNumberError          = Network adapter interface number {0} was specified but {1} adapter(s) where found. Please correct the interface number and try again.
