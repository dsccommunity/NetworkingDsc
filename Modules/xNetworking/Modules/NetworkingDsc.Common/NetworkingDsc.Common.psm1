...
<#
    .SYNOPSIS
        Sets the computer proxy settings.
#>
function Set-ComputerProxySettings
{
    ...
    if ($Ensure -eq 'Absent')
    {
        ...
        'WinHttpSettings','DefaultConnectionSettings','DefaultConnectionSettings' | Foreach-Object -Process {
            Remove-ItemProperty `
...
Export-ModuleMember -Function `
    ...
    Get-DnsClientServerStaticAddress,
    Get-IPAddressPrefix,
    Get-ComputerProxySettings,
    Set-ComputerProxySettings
