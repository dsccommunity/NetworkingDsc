...
$TestEnvironment = Initialize-TestEnvironment `
    ...
    -DSCResourceName 'MSFT_xWeakHostReceive' `
    -TestType Unit
...
{
    #region Pester Tests
    InModuleScope MSFT_xWeakHostReceive {
        ...
        $mockNetIPInterfaceEnabled = [PSObject]@{
            WeakHostReceive = $testNetIPInterfaceEnabled.State
        ...
        Describe 'MSFT_xWeakHostReceive\Set-TargetResource' {
            BeforeEach {
                Mock -CommandName Get-NetAdapter -MockWith { $mockNetAdapter }
        ...
        Describe 'MSFT_xWeakHostReceive\Test-TargetResource' {
            BeforeEach {
                Mock -CommandName Get-NetAdapter -MockWith { $mockNetAdapter }
            }
        ...
        Describe 'MSFT_xWeakHostReceive\Assert-ResourceProperty' {
